        ...
        success: function(data){
            if(data.email){
                ...
                Dml.fun.showErrorTips($('#jsChangeEmailTips'), "Email verification code has been sent");
                 ...
                 Dml.fun.showValidateError($('#jsChangeEmail'), "Mailbox verification code failed to be sent");
            }else if(data.status == 'success'){
            }
        },
        ...
        success: function(data) {
            if(data.email){
                ...
                setTimeout(function(){location.reload();},1000);
                 ...
                 Dml.fun.showValidateError($('#jsChangeEmail'), "Mailbox information update failed");
            }
        },
        complete: function(XMLHttpRequest){
            $btn.val("completed");
            ...
            success: function(data) {
                if(data.password1){
                    ...
                    Dml.fun.showTipsDialog({
                        ...
                        h2:'Change the password successfully, please log in again!',
                    });
                    Dml.fun.winReload();
                }else if(data.msg){
                ...
                if(data.nick_name){
                   ...
                   _showValidateError($('#address'), data.address);
                    ...
                    Dml.fun.showTipsDialog({
                        ...
                        h2: 'Personal information has been modified successfully!'
                    });
