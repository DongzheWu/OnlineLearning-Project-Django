...
var Dml = {};
    Dml.fun = {
        ...
        showTipsDialog: function(obj){
            ...
            var $Box = $('#jsSuccessTips'),
                h1 = obj.title || 'Prompt',
                h2 = obj.h2 || 'Your operation is successful!';
                p = obj.p || '';
                type = obj.type || '';
            $('#jsDialog').show();
            $('#dialogBg').show();
        ...
        showComfirmDialog: function(obj){
            var $Box = $('#jsComfirmDialig'),
                ...
                h2 = obj.h2 || 'Are you sure to submit?',
    ...
    Dml.Msg = {
        epUserName: 'Please enter correct email!',
        erUserName: 'Please enter correct email!',
        epPhone: 'Please enter your phone number!',
        erPhone: 'Please enter correct phone number!',
        epVerifyCode: 'Please enter code!',
        erVerifyCode: 'Please enter correct code!',
        epMail: 'Please enter your email!',
        erMail: 'Please enter corrent email!',
        epPwd: 'Please enter log in password!',
        erPwd: 'The password is 6-20',
        epResetPwd: 'Please enter password!',
        erResetPwd: 'Please enter 6-20 password!',
        epRePwd:'Please enter your password again',
        erRePwd:'The passwords are different!',
        epEmCode: 'Please enter email verify code!',
        erEmCode: 'Please enter correct verify code! ',
        epName: 'Please enter your name!',
        epNickName: 'Please enter your nickname！',
    };